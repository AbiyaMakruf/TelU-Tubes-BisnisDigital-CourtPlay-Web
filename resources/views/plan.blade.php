        ...
        <div class="row justify-content-center g-4">
                    ...
                    <div class="mt-auto">
                        ...
                        @else
                            <form method="POST" action="{{ route('payment.create') }}">
                                ...
                                <button type="submit" class="btn btn-plan">Get Started</button>
                            </form>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 d-flex">
                <div class="pricing-card pricing-card-warning w-100 d-flex flex-column">
                    ...
                    <ul class="feature-list list-unstyled mb-4 flex-grow-1">
                        @foreach($plans['starter']['features'] as $feature)
                            <li><i class="bi bi-check-circle-fill text-warning"></i> {{ $feature }}</li>
                        @endforeach
                    </ul>
                    ...
                    <div class="mt-auto">
                        ...
                        @else
                            <form method="POST" action="{{ route('payment.create') }}">
                                ...
                                <input type="hidden" name="price" value="{{ $plans['starter']['price_idr'] }}">
                                <button type="submit" class="btn btn-plan btn-plan-warning">Buy Once</button>
                            </form>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 d-flex">
                <div class="pricing-card pricing-card-info w-100 d-flex flex-column position-relative overflow-hidden">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="plan-price" style="font-size: 2.5rem;">
                            <span class="small text-decoration-line-through text-white-50 d-block mb-1">Rp129.000</span>
                            <span class="free-trial-text" style="font-size: 2.5rem;">Rp0</span>
                            <span class="small d-block text-white-50 mt-1">Then Rp129.000/mo</span>
                        </div>
                    ...
                    <div class="mt-auto">
                        ...
                        @else
                            <form method="POST" action="{{ route('payment.create') }}">
                                ...
                                <button type="submit" class="btn btn-plan btn-plan-info">Start Free Trial</button>
                            </form>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 d-flex">
                <div class="pricing-card highlight w-100 d-flex flex-column position-relative overflow-hidden">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="plan-price" style="font-size: 2.5rem;">
                            <span class="small text-decoration-line-through text-white-50 d-block mb-1">Rp299.000</span>
                            <span style="font-size: 2.5rem;">Rp209.000</span>
                            <span style="font-size: 0.9rem;">/first mo</span>
                            <span class="small d-block text-white-50 mt-1">Then Rp299.000/mo</span>
                        </div>
                    ...
                    <div class="mt-auto">
                        ...
                        @else
                            <form method="POST" action="{{ route('payment.create') }}">
                                ...
                                <button type="submit" class="btn btn-plan btn-plan-primary">Go Pro Now</button>
                            </form>
                        @endif
                    </div>
                </div>
